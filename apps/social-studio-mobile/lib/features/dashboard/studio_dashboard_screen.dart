...
class ProjectSection {
  ...
  static const all = [
    ...
    ProjectSection('engagement', '180 Engagement', Icons.bolt_rounded),
            ...
            for (final s in ProjectSection.all)
              SectionCard(
                ...
                child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text(s.label, textAlign: TextAlign.center, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600)),
                ]),
              ),
          ],
        ),
