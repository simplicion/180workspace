...
var middlewareSecret = "e050bf78-915a-462b-8f5f-51c7b59cc7ce";
//#endregion
...
async function renderToStaticMarkup(Component, props, { default: children, ...slotted }, metadata) {
	...
	if (children && _astro_react_opts_default.experimentalReactChildren) {
		...
		newProps.children = (await import("./chunks/vnode-children_BNEqZ4Gh.mjs").then((mod) => mod.default))(children);
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["slug"],
			"component": "src/pages/features/[slug].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/features/index.astro",
			"pathname": "/features",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "e050bf78-915a-462b-8f5f-51c7b59cc7ce") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
