...
import { requireSingleFile, handleUpload } from '../../../../system-configs/middleware/system/central-upload';

const router = Router();

router.post('/upload', requireSingleFile('file'), handleUpload('general'), ctrl.uploadFile);
router.post('/upload-voice', requireSingleFile('file'), handleUpload('voice_notes'), ctrl.uploadFile);
