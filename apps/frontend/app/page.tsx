      ...
      <footer className="w-full bg-white/80 backdrop-blur-md py-12 px-6 border-t border-slate-200 relative z-10">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            ...
            <a href={`mailto:support@${process.env.NEXT_PUBLIC_ROOT_DOMAIN || '180workspace.com'}`} className="text-sm font-semibold text-slate-500 hover:text-blue-600 transition-colors">Contact Support</a>
          </div>
