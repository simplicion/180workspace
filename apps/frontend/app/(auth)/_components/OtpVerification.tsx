            ...
            <form onSubmit={handleVerify} className="space-y-8">
                ...
                <div className="flex flex-col gap-4">
                    <button
                        ...
                        className="w-full py-3.5 rounded-2xl font-bold text-white bg-blue-600 hover:bg-blue-700 transition-all duration-300 active:scale-[0.98] hover:scale-[1.02] shadow-lg flex items-center justify-center gap-2"
                    >
                        {isVerifying ? <LogoLoader className="w-5 h-5 animate-spin" /> : null}
                        Verify Code
                    </button>
