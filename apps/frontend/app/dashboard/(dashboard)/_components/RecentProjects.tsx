            ...
            <div className="p-5 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-[11px] text-gray-400 font-medium">Projects recently created or updated</p>
                    </div>
                </div>
                <Link 
                    href="/dashboard/projects" 
                    className="text-[11px] font-bold text-indigo-600 hover:text-indigo-700 hover:bg-indigo-50 px-3 py-1.5 rounded-lg flex items-center gap-1 transition-colors self-start sm:self-auto border border-transparent hover:border-indigo-100"
                >
            ...
            <div className="divide-y divide-gray-50">
                {projects.length === 0 ? (
                    <div className="p-12 text-center">
                        ...
                        <Link href="/dashboard/projects" className="btn-primary mt-4 py-2 px-4 text-xs">
                            Create Project
                        </Link>
                    </div>
                ) : (
                            ...
                            >
                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                    <div className="flex items-start gap-4 flex-1">
                                        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white font-bold text-lg shadow-sm flex-shrink-0 group-hover:scale-110 transition-transform">
                                        ...
                                        <div className="min-w-0 flex-1">
                                            ...
                                            <div className="flex items-center gap-3 text-[11px] text-gray-500 font-medium">
                                                <span className={`px-2 py-0.5 rounded-md border ${getStatusStyles(project.status)} uppercase tracking-wider text-[9px] font-bold`}>
                                    ...
                                    <div className="flex items-center gap-8 w-full md:w-auto">
                                        {/* Task Progress */}
                                        <div className="flex-1 md:w-48 bg-gray-50/50 p-2.5 rounded-xl border border-gray-100">
                                            ...
                                            <div 
                                                className="h-1.5 w-full bg-gray-200/60 rounded-full overflow-hidden"
                                                {...{
                                                    role: "progressbar",
                                            ...
                                            <div className="flex items-center gap-1 mt-1.5">
                                                ...
                                                <span className="text-[10px] text-gray-500 font-medium">{completedTasks}/{totalTasks} Tasks</span>
                                            </div>
                                        </div>
