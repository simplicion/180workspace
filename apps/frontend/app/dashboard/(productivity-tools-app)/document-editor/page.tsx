                        ...
                        {activeTab === 'design' ? (
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex gap-2">
                                            <div className="flex-1 border border-gray-200 rounded-lg flex items-center px-3 bg-white hover:border-gray-300 transition-colors">
                                                ...
                                                <select value={designSettings.fontFamily} onChange={e => dispatch(updateDesignSettings({ fontFamily: e.target.value }))} className="w-full text-sm font-medium py-2.5 bg-transparent focus:outline-none cursor-pointer text-gray-700">
                                        ...
                                        <div className="flex flex-col gap-2 mt-4 pt-4 border-t border-gray-100">
                                            ...
                                            <div className="border border-gray-200 rounded-lg flex items-center px-3 bg-white hover:border-gray-300 transition-colors">
                                                ...
                                                <select value={designSettings.selectedHeaderId || 'none'} onChange={e => {
                                        ...
                                        <div className="flex flex-col gap-2 mt-2">
                                            ...
                                            <div className="border border-gray-200 rounded-lg flex items-center px-3 bg-white hover:border-gray-300 transition-colors">
                                                <LayoutTemplate className="w-4 h-4 text-gray-400 mr-2" />
                                                <select value={designSettings.selectedFooterId || 'none'} onChange={e => {
                                                    const val = e.target.value;
                                            ...
                                            <div className="mt-6 pt-6 border-t border-gray-100">
                                                ...
                                                <div className="space-y-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <select value={selectedBlock.styles?.borderStyle || 'solid'} onChange={(e) => dispatch(updateBlock({ id: selectedBlock.id, updates: { styles: { ...selectedBlock.styles, borderStyle: e.target.value } } }))} className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm font-medium focus:ring-2 focus:ring-[#2563eb] outline-none">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <select value={metaType} onChange={e => dispatch(updateMetaType(e.target.value as MetaType))} className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm font-medium focus:ring-2 focus:ring-[#2563eb] outline-none bg-white">
                                ...
                                {(metaType === 'quotation' || metaType === 'general' || metaType === 'invoice' || metaType === 'contract') && (
                                    <div className="mb-4">
                                        ...
                                        <select onChange={handleProjectSelect} value={documentDetails?.selectedProjectId || ''} className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm font-medium focus:ring-2 focus:ring-[#2563eb] outline-none bg-white mb-3">
                                ...
                                {['quotation', 'invoice', 'contract', 'general'].includes(metaType) && (
                                    <div className="border border-gray-200 rounded-lg p-3 bg-gray-50">
                                        ...
                                        <select onChange={handleClientSelect} value={documentDetails?.selectedClientId || ''} className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm font-medium focus:ring-2 focus:ring-[#2563eb] outline-none bg-white mb-3">
                                ...
                                {['contract', 'general', 'offer_letter'].includes(metaType) && (
                                    <div className="border border-gray-200 rounded-lg p-3 bg-gray-50">
                                        ...
                                        <select onChange={handleEmployeeSelect} value={documentDetails?.selectedEmployeeId || ''} className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm font-medium focus:ring-2 focus:ring-[#2563eb] outline-none bg-white mb-3">
