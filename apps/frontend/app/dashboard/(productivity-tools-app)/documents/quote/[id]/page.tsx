            ...
            <div className="max-w-4xl mx-auto mt-8 bg-white p-12 rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 print:shadow-none print:border-none print:mt-0 print:p-8">
                ...
                <div className="grid grid-cols-2 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">{quote.preparedBy?.email || 'contact@180workspace.com'}</p>
                    </div>
                </div>
                ...
                <div className="flex justify-end mb-12">
                    <div className="w-1/2">
                        <div className="flex justify-between py-2 text-sm text-gray-600">
                            <span>Subtotal</span>
                            <span className="font-medium">${Number(quote.subtotal || quote.total || 0).toFixed(2)}</span>
                        </div>
                        {quote.tax > 0 && (
