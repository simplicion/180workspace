                    ...
                    <div className="fixed inset-0 flex items-center justify-center p-4">
                        <div className="mx-auto max-w-sm rounded-xl bg-white dark:bg-zinc-900 p-6 shadow-2xl border border-zinc-200 dark:border-zinc-800 w-full space-y-4">
                            ...
                            <div>
                                ...
                                <select value={contract.deal || ''} onChange={(e) => setContract({...contract, deal: e.target.value})} className="w-full bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg px-3 py-2 outline-none focus:border-indigo-500">
