...
export default function TemplatesListDrawer({
    ...
    return (
        <Drawer open={true} onClose={onClose} title="Document Templates" position="right">
            <div className="flex bg-white rounded-2xl w-full max-w-5xl max-h-[92vh] flex-col overflow-hidden shadow-2xl">
