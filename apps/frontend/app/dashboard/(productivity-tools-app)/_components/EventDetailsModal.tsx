        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-5xl h-[85vh] flex overflow-hidden">
                ...
                <div className="flex-1 flex flex-col bg-white overflow-hidden relative">
                    <button onClick={onClose} className="absolute top-4 right-4 z-10 w-8 h-8 rounded-lg hover:bg-gray-100 flex items-center justify-center text-gray-500 bg-white/80 backdrop-blur-sm border border-gray-100 shadow-sm">
                        <X className="w-5 h-5" />
                    </button>
