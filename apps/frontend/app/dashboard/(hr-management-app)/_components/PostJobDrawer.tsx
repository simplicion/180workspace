...
export default function PostJobDrawer({ open, onClose, onSuccess, editJob }: Props) {
    ...
    return (
        <Drawer open={open} onClose={onClose} title={isEdit ? 'Edit Job' : 'Post a Job'} icon={<Briefcase className="w-5 h-5 text-green-600" />}>
