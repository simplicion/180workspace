...
export function LeaveRequestDrawer({ open, onClose, onSuccess }: { open: boolean; onClose: () => void; onSuccess: () => void }) {
    ...
    return (
        <Drawer open={open} onClose={onClose} title="Request Leave">
...
export function ViewLeaveDrawer({ open, leave, onClose }: { open: boolean; leave: any; onClose: () => void }) {
    if (!leave && open) return null;
    return (
        <Drawer open={open} onClose={onClose} title="Leave Details">
            {leave && (
