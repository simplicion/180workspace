...
export default function PostJobModal({ onClose, onSuccess, editJob }: Props) {
    ...
    const [form, setForm] = useState({
        ...
        salaryRangeMin: editJob?.salaryRangeMin || '',
        salaryRangeMax: editJob?.salaryRangeMax || '',
        experienceLevel: editJob?.experienceLevel || 'Entry Level',
        workModel: editJob?.workModel || 'On-site',
                ...
                <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto px-6 py-5 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <select value={form.experienceLevel} onChange={set('experienceLevel')} className="select">
                        ...
                        <div>
                            ...
                            <select value={form.workModel} onChange={set('workModel')} className="select">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        <div>
                            ...
                            <select value={form.currency} onChange={set('currency')} className="select">
                        ...
                        <div>
                            ...
                            <input value={form.salaryRangeMin} onChange={set('salaryRangeMin')} type="number" placeholder="e.g. 500000" className="input" />
                        </div>
                        <div>
                            <label className="label">Max Salary</label>
                            <input value={form.salaryRangeMax} onChange={set('salaryRangeMax')} type="number" placeholder="e.g. 1000000" className="input" />
                        </div>
                    </div>
