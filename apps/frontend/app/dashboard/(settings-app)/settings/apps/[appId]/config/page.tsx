                    ...
                    {activeTab === 'configs' && (
                        ...
                        >
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="p-5 rounded-2xl border border-gray-100 flex items-center justify-between hover:border-indigo-100 transition-colors">
                                    ...
                                    {hasGlobalAI ? (
                                        ...
                                        <Link href="/dashboard/settings/system-configs" className="px-4 py-2 bg-indigo-600 text-white rounded-xl text-xs font-bold hover:bg-indigo-700 transition-colors">
                                            Setup Globally
                                        </Link>
                                    )}
                                </div>
                                ...
                                {(app.id === 'finance' || app.id === 'crm' || app.id === 'hr') && (
                                    <div className="p-5 rounded-2xl border border-gray-100 flex items-center justify-between hover:border-indigo-100 transition-colors">
                                        ...
                                        {hasGlobalFinance ? (
                                            ...
                                            <Link href="/dashboard/settings?tab=finance" className="px-4 py-2 border border-gray-200 text-gray-600 rounded-xl text-xs font-bold hover:bg-gray-50 transition-all">
                                                Configure Finance
                                            </Link>
                                        )}
                                    </div>
                            ...
                            <div className="pt-4 text-center">
                                <Link href="/dashboard/settings/system-configs" className="text-sm font-bold text-indigo-600 hover:underline underline-offset-2">
