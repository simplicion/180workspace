...
export const TARGET_VALUE_PRESETS: Record<string, PresetOption[]> = {
  ...
  referrer: [
    ...
    { value: 'youtube.com', label: '▶️ YouTube (youtube.com)' },
  ...
  sec_ch_ua: [
    ...
    { value: 'Chromium', label: '🛡️ Chromium Engine' },
    { value: 'Google Chrome', label: '🔍 Google Chrome Browser' },
    { value: 'Mobile Safari', label: '🧭 Mobile Safari WebKit' },
    { value: 'HeadlessChrome', label: '⚠️ Headless Chrome (Bot Signature)', badge: 'Bot' },
  ],
  ...
  gpu_renderer: [
    ...
    { value: 'swiftshader', label: '⚠️ Google SwiftShader (Virtual Cloud Reviewer)', badge: 'Bot Detected' },
    { value: 'llvmpipe', label: '⚠️ Mesa LLVMpipe (Linux Server Headless)', badge: 'Bot Detected' },
    { value: 'mesa', label: '⚠️ Mesa Software Rasterizer', badge: 'Bot Detected' },
  ],
  ...
  network_type: [
    ...
    { value: 'vpn', label: '🛡️ Commercial VPN / Anonymous Proxy' },
  ],
  ...
  asn_provider: [
    ...
    { value: 'CLOUDFLARE', label: '☁️ Cloudflare (ASN 13335)' },
  ],
  ...
  touch_support: [
    ...
    { value: 'false', label: '🖱️ No Touch Points (Desktop or Emulated Bot)' },
  ],

  battery_valid: [
    { value: 'true', label: '🔋 Realistic Battery (< 100% or Discharging)', badge: 'Real Device' },
    { value: 'false', label: '⚠️ Static 100% Charging (Cloud Emulators & Scrapers)' },
  ],
  ...
  time_range: [
    ...
    { value: 'afternoon', label: '☀️ Afternoon Hours (12:00 - 18:00)' },
