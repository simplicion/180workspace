...
const QUICK_LINKS = [
    ...
    {
        href: '/help-support/release-notes',
        icon: FileText,
        label: 'Release Notes',
        sub: "View what's new",
        iconBg: 'bg-blue-50',
        ...
        <div className="w-full space-y-8">
            ...
            <div>
                ...
                <div className="flex sm:hidden mt-6 justify-center">
                    <Link href='/help-support/docs' className="flex items-center gap-1 text-indigo-600 font-bold text-sm">
                        View All Documentation <ChevronRight className="w-4 h-4" />
                    </Link>
                </div>
            </div>
            ...
            <div className="bg-gray-900 rounded-2xl p-8 md:p-10 text-center shadow-lg relative overflow-hidden">
                <div className="relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <a
                            href={`mailto:support@${process.env.NEXT_PUBLIC_ROOT_DOMAIN || process.env.NEXT_PUBLIC_MAIN_DOMAIN || ''}`}
                        ...
                        >
                            ...
                            support@{process.env.NEXT_PUBLIC_ROOT_DOMAIN || process.env.NEXT_PUBLIC_MAIN_DOMAIN || ''}
                        </a>
                        <a
