            ...
            <div className="page-header flex justify-between items-start mb-6">
                ...
                <div className="flex flex-col sm:flex-row items-end sm:items-center gap-3">
                    ...
                    <div className="flex items-center gap-2 border-l border-gray-200 pl-3">
                        <Link href='/sales/deals' className="btn-secondary h-10">Leads</Link>
                        <Link href='/sales/leads-pipeline' className="btn-primary flex items-center gap-2 h-10">
                ...
                <div className="mb-6 space-y-3">
                    {data.anomalies.map((anom: any, idx: number) => (
                        <div key={idx} className="flex items-center justify-between gap-4 p-4 rounded-xl bg-orange-50 border border-orange-200">
                            ...
                            <Link href='/sales/leads-pipeline' className="text-sm font-medium text-orange-700 hover:text-orange-900 bg-white px-3 py-1.5 rounded-lg border border-orange-200 hover:border-orange-300 transition-colors">
                                Review Deal
                            </Link>
                        </div>
                    ))}
