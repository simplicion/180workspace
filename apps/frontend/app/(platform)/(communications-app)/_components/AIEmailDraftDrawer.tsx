...
export default function AIEmailDraftDrawer({ onClose, onApply, recipientName, context }: AIEmailDraftModalProps) {
    ...
    return (
        <Drawer open={true} onClose={onClose} title="AI Writing Assistant" position="right">
