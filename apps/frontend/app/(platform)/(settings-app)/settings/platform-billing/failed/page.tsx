...
export default function PaymentFailedPage() {
    ...
    return (
        <div className="max-w-2xl mx-auto py-16 px-4 text-center">
            ...
            <Link href='/settings/platform-billing' className="inline-flex items-center gap-2 mt-12 text-sm font-medium text-slate-400 hover:text-indigo-600 transition-colors">
