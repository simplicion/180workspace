...
import { Settings2, Globe, Search } from 'lucide-react';
...
export default function PageSettingsModal({ config, setConfig, onSave, domain = 'yourdomain.com' }: PageSettingsModalProps) {
    ...
    const modalContent = (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center bg-black/60 p-4" style={{ zIndex: 99999 }}>
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-xl flex flex-col max-h-[90vh] overflow-hidden border border-gray-100">
                {/* Header */}
                <div className="p-4 px-6 border-b border-gray-100 flex justify-between items-center bg-gradient-to-r from-gray-50 to-indigo-50/30">
                    <div className="flex items-center gap-2.5">
                        ...
                        <div>
                            ...
                            <p className="text-[11px] text-gray-500">Configure page details, URL slug, and search ranking metadata</p>
                        </div>
                    </div>
