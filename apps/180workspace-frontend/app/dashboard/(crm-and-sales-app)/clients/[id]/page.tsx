...
export default function ClientProfilePage() {
    ...
    function handleCreateInvoice() {
        router.push(`/dashboard/invoices/new?clientId=${id}&clientName=${encodeURIComponent(client?.name || '')}`);
    }
...
function ClientOverview({ client, onCreateInvoice }: any) {
    const ACTIONS = [
        ...
        },
        {
            ...
            href: `/dashboard/projects?clientId=${client.id}&clientName=${encodeURIComponent(client.name)}`,
        },
        {
