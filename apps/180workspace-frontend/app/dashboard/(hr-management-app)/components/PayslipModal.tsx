...
export default function PayslipModal({ salary, onClose }: { salary: any; onClose: () => void }) {
            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-3xl my-8 print:my-0 print-shadow relative">
                ...
                <div className="flex items-center justify-between px-8 py-4 border-b border-gray-100 bg-gray-50 rounded-t-xl no-print sticky top-0 z-10">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button title="Close Payslip" onClick={onClose} className="w-8 h-8 rounded-full bg-white border border-gray-200 hover:bg-gray-100 flex items-center justify-center transition-colors"><X className="w-4 h-4 text-gray-500" /></button>
                    </div>
                </div>
