...
mod tests {
    ...
    #[test]
    fn a_plan_with_photos_and_every_effect_type_is_accepted() {
        // Generated by buildNativeRenderPlan() for a project with a cover photo and all six effect types
        // (flash, fade_black, shake, zoom_pulse, black_white, vignette); rendered against real FFmpeg in
        ...
        for f in ["split=2", "zoompan=", "crop=", "hue=", "vignette=", "fade="] {
