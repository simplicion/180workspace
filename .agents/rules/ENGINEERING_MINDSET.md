...
*Derived from `Prince364133/Engneering-arctech` (Engineering Design Vault). This is the lens Claude applies whenever it plans, reviews, or writes architecture/LLD docs for Prince's projects (IMS, PitchIn180, Kridaz, VehicleXchange, etc.), before handing work to AntiGravity AI for implementation.*
