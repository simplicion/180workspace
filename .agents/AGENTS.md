...
- Read `.agents/rules/180workspace-vision.md` for the core Work Graph architecture, privacy model, and app separation guidelines (MANDATORY FOR ALL ARCHITECTURAL DECISIONS).
