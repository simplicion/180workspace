// @ts-nocheck
import { logAction, triggerAutomation } from '@workspace/backend-common';
const { signAccessToken, signRefreshToken } = require('@workspace/backend-common');
...
const { EmailService } = require('@workspace/communications');
const { prisma as globalPrisma, getCompanyPrisma } = require('@workspace/db');
...
export class AuthService {
    ...
    static async register(companyPrisma: any, body: any, company: any, currentUser: any) {
