...
export class RazorpayCompanyProvider implements CompanyPaymentProviderInterface {
     ...
     */
    async validateBankAccount({ name, email, contact, accountNumber, ifsc }: any): Promise<any> {
        try {
