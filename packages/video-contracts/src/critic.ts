...
import { MediaTelemetryManifest } from "./telemetry.schema";
import { EditCommand } from "./commands.schema";
...
function generateUUID(): string {
  ...
  return "critic_" + Math.random().toString(36).substring(2, 11) + "_" + Date.now().toString(36);
}
